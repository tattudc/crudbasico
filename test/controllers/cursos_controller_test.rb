...
class CursosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post cursos_url, params: { curso: { descricao: @curso.descricao, dia_hora: @curso.dia_hora, nome: @curso.nome, qtde_vagas: @curso.qtde_vagas } }
    end
  ...
  test "should update curso" do
    patch curso_url(@curso), params: { curso: { descricao: @curso.descricao, dia_hora: @curso.dia_hora, nome: @curso.nome, qtde_vagas: @curso.qtde_vagas } }
